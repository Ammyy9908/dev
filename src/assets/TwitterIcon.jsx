...
function TwitterIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ar6e55ebmvo7j89tjigfw0cladhk0qme" class="crayons-icon"><title id="ar6e55ebmvo7j89tjigfw0cladhk0qme">Twitter</title>
